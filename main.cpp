...
ResultType HandleOption (int option)
{
    ...
    switch (option)
    {
        case 1:   PTOrs = gDb.Create();       break;
        case 2:   PTOrs = gDb.Read();         break;
        case 3:   PTOrs = gDb.AddPTOHours();  break;
        case 4:   PTOrs = gDb.UsePTOHours();  break;
        case 5:           gDb.PrintHistory(); break;
        case 6:           gDb.PrintCurrent(); break;
        case 7:   PTOrs = gDb.Save();         break;
        case 0:
